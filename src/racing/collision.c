...
void func_802AAAAC(CollisionData* collision) {
...
s32 check_collision_zx(CollisionData* collision, f32 boundingBoxSize, f32 posX, f32 posY, f32 posZ, u16 index) {
...
s32 check_collision_yx(CollisionData* collision, f32 boundingBoxSize, f32 posX, f32 posY, f32 posZ, u16 index) {
    CollisionTriangle* triangle = &gCollisionMesh[index];
    UNUSED f32 pad[6];
    f32 x3;
    f32 y3;
...
s32 check_collision_zy(CollisionData* collision, f32 boundingBoxSize, f32 posX, f32 posY, f32 posZ, u16 index) {
    CollisionTriangle* triangle = &gCollisionMesh[index];
    s32 b = true;
    UNUSED f32 pad[7];
    f32 y3;
...
f32 func_802ABEAC(CollisionData* collision, Vec3f pos) {
...
void shell_collision(CollisionData* collision, Vec3f velocity) {
...
s32 is_colliding_with_drivable_surface(CollisionData* collision, f32 boundingBoxSize, f32 newX, f32 newY, f32 newZ,
 ...
 * Wall collision
 */
s32 is_colliding_with_wall2(CollisionData* arg, f32 boundingBoxSize, f32 x1, f32 y1, f32 z1, u16 surfaceIndex, f32 posX,
                            f32 posY, f32 posZ) {
 ...
 */
s32 is_colliding_with_wall1(CollisionData* arg, f32 boundingBoxSize, f32 x1, f32 y1, f32 z1, u16 surfaceIndex, f32 posX,
                            f32 posY, f32 posZ) {
    if (CVarGetInteger("gNoWallColision", 0)) {
        return NO_COLLISION;
    }
...
u16 actor_terrain_collision(CollisionData* collision, f32 boundingBoxSize, f32 newX, f32 newY, f32 newZ, f32 oldX, f32 oldY,
                            f32 oldZ) {
    s32 trackLengthX;
    s32 trackLengthZ;
    s16 sectionIndexX;
...
u16 check_bounding_collision(CollisionData* collision, f32 boundingBoxSize, f32 posX, f32 posY, f32 posZ) {
    u16 numTriangles;
    s32 trackLengthX;
    s32 trackLengthZ;
    u16 meshIndex;
