...
void SherbetLand::Render(struct ScreenContext* arg0) {
...
void SherbetLand::DrawWater(struct ScreenContext* screen, uint16_t pathCounter, uint16_t cameraRot, uint16_t playerDirection) {
