...
// Texture-pack cloud UVs: S spans one sheet width (0..2016; the old 4032 drew
// every cloud twice side by side) and each T slice sits one source texel (32
// units) up so the sampled band matches the renderer's sampling convention.
Vtx cloudvtx[4][4] = { {
